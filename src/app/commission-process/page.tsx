...
import { ArrowLeft, ArrowRight, Info, Calendar, Sparkles, ClipboardEdit, Search, CreditCard, Clock, Palette, Wallet, Truck, Package } from "lucide-react";
...
export default function CommissionProcessPage() {
    return (
        <div className="min-h-screen bg-background text-foreground pt-16 md:pt-32 pb-16 md:pb-24 selection:bg-[#e7bb55]/30 selection:text-[#e7bb55]">
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="mb-20">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-serif mb-8 leading-tight text-foreground">
                            The Commission <span className="text-[#e7bb55]">Process</span>
                        </h1>
                        <p className="text-neutral-500 dark:text-neutral-400 text-xl leading-relaxed max-w-2xl font-light italic">
                ...
                >
                    <div className="absolute inset-0 bg-surface/50 dark:bg-[#e7bb55]/[0.02] border border-[#e7bb55]/10 dark:border-[#e7bb55]/20 rounded-[2.5rem] shadow-xl shadow-black/5 dark:shadow-none" />
                    <div className="absolute top-0 right-0 py-8 px-12 opacity-5 overflow-hidden rounded-[2.5rem]">
                    ...
                    <div className="relative p-10 md:p-14">
                        ...
                        <div className="space-y-6 text-neutral-600 dark:text-neutral-300 text-lg leading-relaxed font-light">
                            <p>
                                To ensure every portrait receives the time and detail it deserves, I only work on <strong className="text-foreground font-semibold">2 active commissions per month</strong>. This allows me to focus completely on the unique features and character of each subject.
                            </p>
                            <p>
                                My total capacity is capped at <strong className="text-foreground font-semibold">4 slots</strong>: 2 for immediate work and 2 for waitlist reservations. If all immediate slots are filled, you can still reserve your place for the next available month via the waitlist.
                            </p>
                        </div>
                    </div>
                </motion.div>
                ...
                <ol className="relative space-y-0">
                    ...
                    {steps.map((step, i) => (
                        ...
                        >
                            {/* Step number bubble */}
                            <div className="hidden sm:flex absolute left-0 top-0.5 w-12 h-12 rounded-full border border-[#e7bb55]/30 bg-background items-center justify-center z-10 shadow-[0_0_20px_rgba(231,187,85,0.1)] group-hover:border-[#e7bb55] transition-colors">
                            ...
                            <div
                                className={`group relative rounded-[2rem] border transition-all duration-500 p-8 md:p-12 ${
                                    step.isAlternate
                                        ...
                                        : "border-border/50 dark:border-white/5 bg-foreground/[0.01] hover:bg-foreground/[0.03] hover:border-border dark:hover:border-white/10"
                                } shadow-xl`}
                            >
                                {step.isAlternate && (
                                ...
                                <h2 className="text-2xl md:text-3xl font-serif text-foreground mb-6 group-hover:text-[#e7bb55] transition-colors flex items-center gap-4">
                                    <step.icon size={24} className="text-[#e7bb55] opacity-80" />
                                    {step.title}
                                </h2>
                                
                                <p className="text-neutral-500 dark:text-neutral-400 text-lg leading-relaxed mb-8 font-light">
                                    {step.description}
                                </p>

                                <div className="space-y-4">
                                    <div className="flex items-start gap-4 p-6 bg-foreground/[0.02] border border-border/50 dark:border-white/5 rounded-2xl group-hover:border-[#e7bb55]/20 group-hover:bg-[#e7bb55]/[0.01] transition-all">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-sm text-neutral-600 dark:text-neutral-500 leading-relaxed font-light italic">
                                                {step.note}
                                            </p>
                                        </div>
                                    </div>
                ...
                >
                    <p className="text-neutral-500 dark:text-neutral-400 mb-10 text-xl font-light italic">
                        Ready to start your journey?
                    </p>
                    <Link
                        href="/#commission-form"
                        className="inline-flex items-center gap-3 px-10 py-5 bg-foreground text-background font-bold rounded-2xl hover:opacity-90 transition-all group shadow-2xl dark:shadow-[0_10px_40px_rgba(255,255,255,0.1)]"
                    >
