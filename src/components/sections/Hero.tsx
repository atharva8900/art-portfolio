...
export default function Hero() {
    ...
    useGSAP(() => {
        ...
        tl.from(beyondLoadRef.current, { y: 30, opacity: 0, duration: 1.2, delay: 0.1, ease: "power4.out", clearProps: "all" })
            .from(realismLoadRef.current, { y: 30, opacity: 0, duration: 1.2, ease: "power4.out", clearProps: "all" }, "-=1.0")
            .from(descriptionLoadRef.current, { opacity: 0, y: 15, duration: 0.8, clearProps: "all" }, "-=0.8")
            .from(ctaLoadRef.current, { opacity: 0, y: 10, duration: 0.8, clearProps: "all" }, "-=0.7");
