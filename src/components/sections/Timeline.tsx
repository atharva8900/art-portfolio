...
export default function Timeline() {
    return (
        <section className="py-24 px-6 md:px-12 bg-background text-foreground overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <GlowingShadow>
                        <motion.div
                            ...
                            className="p-6 md:p-12 flex flex-col items-center text-center space-y-6 w-full h-full"
                        >
                    ...
                    <GlowingShadow>
                        <motion.div
                            ...
                            className="p-12 flex flex-col items-center text-center space-y-6 w-full h-full"
                        >
                            <div className="p-4 bg-accent/10 rounded-full text-accent">
