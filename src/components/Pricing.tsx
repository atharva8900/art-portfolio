...
// Ultra-stable entrance variants for the whole group
const sectionRevealVariants = {
    ...
    visible: {
        ...
        transition: {
            duration: 0.8,
            ease: [0.22, 1, 0.36, 1] // Exponential out for that "premium" glide
        }
    }
};
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: false }}
                        variants={sectionRevealVariants}
                        className="p-6 sm:p-8 md:p-10 rounded-2xl bg-background dark:bg-foreground/5 border border-border/80 dark:border-foreground/10 shadow-sm dark:shadow-none"
                    >
                        <h2 className="font-serif text-3xl md:text-4xl text-foreground mb-8">Portrait Pricing</h2>

                        {pricingData.isEarlyAccess && (
                            <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-foreground/5 dark:bg-accent/10 border border-border/50 dark:border-accent/30">
                                <span className="w-2 h-2 rounded-full bg-foreground/70 dark:bg-accent animate-pulse" />
                                <span className="text-xs font-bold text-foreground/70 dark:text-accent uppercase tracking-wider transition-opacity duration-300">
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-2xl font-black text-foreground/80 dark:text-accent tracking-tight transition-opacity duration-300">
                                                {item.price}
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <p className="mt-6 text-sm text-neutral-600 dark:text-neutral-400 text-center leading-relaxed">
                            {pricingData.isEarlyAccess
                    ...
                    <motion.div
                        ...
                        viewport={{ once: false }}
                        variants={sectionRevealVariants}
                        className="p-6 sm:p-8 md:p-10 rounded-2xl bg-background dark:bg-foreground/5 border border-border/80 dark:border-foreground/10 shadow-sm dark:shadow-none h-full flex flex-col"
                    >
