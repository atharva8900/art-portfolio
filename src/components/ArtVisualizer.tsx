    ...
    const content = (
        <div className={`${embedded ? 'max-w-5xl mx-auto' : 'max-w-7xl mx-auto'} ${className}`}>
            ...
            <div id="visualizer-container" className="flex flex-col lg:grid lg:grid-cols-12 gap-0 lg:gap-8 h-full items-stretch overflow-hidden bg-background">
                ...
                <div className="lg:col-span-8 w-full shrink-0 h-[52vh] lg:h-full flex flex-col items-center justify-center gap-4 relative bg-surface/50 lg:overflow-y-auto lg:py-8 lg:px-4">
                ...
                <div className="lg:col-span-4 flex-1 min-h-[44vh] lg:h-full lg:min-h-0 bg-surface border-t-0 lg:border lg:border-foreground/5 rounded-t-3xl lg:rounded-3xl lg:self-stretch shadow-[0_-8px_30px_rgba(0,0,0,0.4)] lg:shadow-sm flex flex-col">
